...
export class AreaChartComponent {
  ...
  private getOptimalTimeInterval(
    ...
    const intervals: Array<{
      ...
      { threshold: 2, interval: timeHour.every(4)!, format: '%H:%M', ticksPerUnit: 6 },
      { threshold: 7, interval: timeDay.every(1)!, format: '%b %d', ticksPerUnit: days },
      { threshold: 14, interval: timeDay.every(2)!, format: '%b %d', ticksPerUnit: days / 2 },
      { threshold: 30, interval: timeWeek.every(1)!, format: '%b %d', ticksPerUnit: days / 7 },
      { threshold: 90, interval: timeWeek.every(2)!, format: '%b %d', ticksPerUnit: days / 14 },
      { threshold: 180, interval: timeMonth.every(1)!, format: '%b', ticksPerUnit: months },
      { threshold: 365, interval: timeMonth.every(2)!, format: '%b', ticksPerUnit: months / 2 },
      {
        threshold: 730,
      ...
      { threshold: Infinity, interval: timeYear.every(1)!, format: '%Y', ticksPerUnit: years },
    ];
